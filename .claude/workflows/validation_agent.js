...
const endpoints = [
  { method: 'GET', path: '/api/lab/tests', name: 'List Tests' },
  { method: 'POST', path: '/api/lab/tests', name: 'Create Test' },
  { method: 'GET', path: '/api/lab/tests/{test_id}', name: 'Get Test' },
  { method: 'PATCH', path: '/api/lab/tests/{test_id}', name: 'Update Test' },
  { method: 'DELETE', path: '/api/lab/tests/{test_id}', name: 'Delete Test' },
  { method: 'GET', path: '/api/lab/tests/code/{code}', name: 'Get Test by Code' },
  { method: 'POST', path: '/api/lab/orders', name: 'Create Order' },
  { method: 'GET', path: '/api/lab/orders', name: 'List Orders' },
  { method: 'GET', path: '/api/lab/orders/{order_id}', name: 'Get Order' },
  { method: 'PATCH', path: '/api/lab/orders/{order_id}', name: 'Update Order' },
  { method: 'POST', path: '/api/lab/orders/{order_id}/collect', name: 'Collect Sample' },
  { method: 'PATCH', path: '/api/lab/orders/{order_id}/tests/{test_id}/status', name: 'Update Test Status' },
  { method: 'GET', path: '/api/lab/orders/{order_id}/history', name: 'Get Status History' },
  { method: 'POST', path: '/api/lab/orders/{order_id}/tests/{test_id}/result', name: 'Submit Result' },
  { method: 'GET', path: '/api/lab/orders/{order_id}/results', name: 'Get Results' },
  { method: 'PATCH', path: '/api/lab/results/{result_id}/review', name: 'Review Result' },
  { method: 'GET', path: '/api/lab/stats', name: 'Lab Statistics' },
  { method: 'GET', path: '/api/lab/orders/stats/specialty/{type}', name: 'Specialty Stats' },
]
